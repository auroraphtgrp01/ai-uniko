    ...
    def __init__(self):
        ...
        self.responses = {
            ...
            "user_sad": [
                ...
                "*vỗ đầu nhẹ* Này... đừng có mà buồn nữa! T-tôi sẽ giúp bạn quản lý tiền tốt hơn... M��! Không phải vì tôi quan tâm đâu! 💝",
            ...
            "user_compliment": [
                ...
                "Này này! *véo má* Đ��ng có nịnh tôi! Mà... nếu bạn muốn khen thêm thì... tôi cũng không cấm... 😤",
